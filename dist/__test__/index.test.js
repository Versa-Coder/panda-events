...
function doTest(ev) {
    describe(">> Testing pandaEvents", () => {
        ...
        test(">> Capture removal of event listener", (done) => {
            ...
            ev.on("removeListener", (evtName, listener) => {
                if (ignoreNewListenersList.includes(evtName)) {
                    done();
                }
...
doTest((0, __1.pandaEvents)());
doTest(new __1.PandaEvents({ global: false }));
